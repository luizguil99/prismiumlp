...
export function ConfettiPricingSection({
  plans = defaultPlans,
  title = "Simple, Transparent Pricing",
  description = "Choose the perfect plan for your needs. All plans include our core AI website building features."
}) {
    ...
    <section id="pricing" className="py-20">
      <div className="container px-4 md:px-6">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-muted-foreground text-lg whitespace-pre-line max-w-[700px] mx-auto">
            {description}
          </p>
        </div>
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={cn(
                ...
                !plan.isPopular && "mt-5",
                index === 0 || index === 2
                  ? "z-0 transform translate-x-0 translate-y-0 -translate-z-[50px]"
                  : "z-10",
