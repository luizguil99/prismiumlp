      ...
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="space-y-4">
            <h3 className="text-lg font-bold">Prismium</h3>
            <p className="text-sm text-muted-foreground">
              AI-powered website builder for creating beautiful, responsive websites in minutes.
            </p>
        ...
        <div className="mt-12 border-t pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Prismium. All rights reserved.
          </p>
